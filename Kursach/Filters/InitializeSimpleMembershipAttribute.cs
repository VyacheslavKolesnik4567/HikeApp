...
namespace HikeApp.Filters
{
    ...
    public sealed class InitializeSimpleMembershipAttribute : ActionFilterAttribute
    {
        ...
        private class SimpleMembershipInitializer
        {
            ...
            {
                Database.SetInitializer<HikeContext>(null);

                try
                {
                    using (var context = new HikeContext())
                    {
                    ...
                    WebSecurity.InitializeDatabaseConnection("HikeContext", "UserProfile", "UserId", "UserName", autoCreateTables: true);
                }
                catch (Exception ex)
                {
