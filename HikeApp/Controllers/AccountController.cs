        ...
        public ActionResult Register(RegisterModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                try
                {
                    ...
                    //If fields are set
                    if (!string.IsNullOrEmpty(model.FirstName) && !string.IsNullOrEmpty(model.LastName) && !string.IsNullOrEmpty(model.Phone) && !string.IsNullOrEmpty(model.Birthday))
                    {
                        var date = model.Birthday.Split('.');
                        ...
                        touristRepository.Create(
                            new Tourist()
                            {
                                ...
                                TouristLastName = model.LastName,
                                Birthday = birthday,
                                Gender = model.Gender,
                                Phone = model.Phone
                            });
